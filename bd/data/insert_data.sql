-- ===========================
-- DATOS INICIALES: GESTIÓN DE AYUDANTES FIS-EPN
-- ===========================
...
('AYD014', 'PII-16-07', '2023-08-01', 'FINALIZADO', 15, 4.50);
...
('MSG001', '2024-01-15 10:30:00', 'Revisión de planificación de ayudantes', 'Estimado Director, solicito revisar la planificación de ayudantes para el próximo semestre.', 'JEF001', 'EPN001', 'PII-19-02', TRUE),
('MSG002', '2024-01-16 14:20:00', 'Informe de progreso trimestral', 'Por favor enviar informe de progreso del proyecto PII-18-04 antes del 30 de enero.', 'JEF001', 'EPN004', 'PII-18-04', FALSE),
('MSG003', '2024-01-17 09:15:00', 'Capacitación en seguridad informática', 'Invitación a capacitación en nuevas técnicas de seguridad el próximo viernes.', 'EPN008', 'EPN001', NULL, TRUE),
('MSG004', '2024-01-18 11:45:00', 'Solicitud de ampliación de presupuesto', 'Solicito considerar ampliación de presupuesto para contratación de ayudantes adicionales.', 'EPN015', 'JEF001', 'PIGR-19-07', FALSE);
...
('NOT001', '2024-01-10 08:30:00', 'Se ha registrado un nuevo ayudante: CARLOS MARTINEZ en el proyecto PII-19-02', 'NUEVO_AYUDANTE', TRUE, 'JEF001', 'PII-19-02', 'AYD001'),
('NOT002', '2024-01-12 16:45:00', 'El ayudante DAVID TORRES ha sido dado de baja del proyecto PII-17-11', 'BAJA_AYUDANTE', FALSE, 'JEF001', 'PII-17-11', 'AYD007'),
('NOT003', '2024-01-14 10:20:00', 'El proyecto PIS-20-02 ha alcanzado el 75% de sus objetivos', 'PROGRESO_PROYECTO', FALSE, 'JEF001', 'PIS-20-02', NULL),
('NOT004', '2024-01-15 14:15:00', 'Recordatorio: Reunión de evaluación de proyectos el próximo martes', 'RECORDATORIO', TRUE, 'JEF001', NULL, NULL);
