...
public class VistaLogin extends JFrame {
    ...
    private JPanel crearPanelFormulario() {
        ...
        btnMostrarPassword = new JButton(IconManager.getInstance().getEyeIcon(20));
    ...
    private void configurarEventos() {
        btnIngresar.addActionListener(e -> {
            ...
            controlador.intentarAutenticar(credenciales.get("correo"), credenciales.get("password"));
        });
        ...
        btnMostrarPassword.addActionListener(e -> {
            if (txtPassword.getEchoChar() == 0) {
                ...
                btnMostrarPassword.setIcon(IconManager.getInstance().getEyeIcon(20));
            } else {
                txtPassword.setEchoChar((char) 0);
                btnMostrarPassword.setIcon(IconManager.getInstance().getEyeCrossedIcon(20));
            }
        });
    }

    // La vista no decide autenticación ni navegación; delega al controlador

    // Métodos de ayuda para mensajes (usados por el controlador)
