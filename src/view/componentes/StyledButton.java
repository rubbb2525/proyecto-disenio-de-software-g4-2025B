...
/**
 * Botón con estilos y efectos hover/press.
 */
public class StyledButton extends JButton {
    ...
    private void configurarEstilo(TipoBoton tipo) {
        switch (tipo) {
            case PRIMARIO:
                colorNormal = new Color(0, 61, 165);
                colorHover = new Color(16, 84, 184);
            ...
            case SECUNDARIO:
                ...
                break;
            case EXITO:
                colorNormal = new Color(39, 174, 96);
                colorHover = new Color(46, 204, 113);
                colorPress = new Color(30, 130, 76);
                setForeground(Color.WHITE);
                break;
            case PELIGRO:
                colorNormal = new Color(231, 76, 60);
                colorHover = new Color(242, 120, 107);
                colorPress = new Color(192, 57, 43);
                setForeground(Color.WHITE);
                break;
            case ADVERTENCIA:
                colorNormal = new Color(243, 156, 18);
