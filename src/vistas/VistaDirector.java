...
public class VistaDirector extends JFrame {
    ...
    private JPanel crearPanelSuperior() {
        ...
        JLabel lblUsuario = new JLabel("👤 Director: " + (director != null ? director.getNombresCompletos() : "Juan Pérez"));
    ...
    private JPanel crearSeccionAyudantes() {
        ...
        // Título
        JLabel lblTitulo = new JLabel("👥 GESTIÓN DE AYUDANTES");
        lblTitulo.setFont(new Font("Arial", Font.BOLD, 14));
        lblTitulo.setForeground(COLOR_TEXTO_PRINCIPAL);
        lblTitulo.setAlignmentX(Component.LEFT_ALIGNMENT);
    ...
    private JPanel crearSeccionMensajes() {
        ...
        JLabel lblTitulo = new JLabel("📩 MENSAJES RECIBIDOS");
        lblTitulo.setFont(new Font("Arial", Font.BOLD, 14));
        lblTitulo.setForeground(COLOR_TEXTO_PRINCIPAL);
        ...
        StyledButton btnResponder = new StyledButton("✉️ Responder", StyledButton.TipoBoton.PRIMARIO);
    ...
    private void configurarEventos() {
        btnRegistrarAyudante.addActionListener(e -> mostrarFormularioAyudante());
        btnDarDeBaja.addActionListener(e -> mostrarDialogoDarDeBaja());
        btnActualizar.addActionListener(e -> {
            if (director != null && director.getProyectoAsignado() != null) {
                actualizarDatosProyecto(director.getProyectoAsignado());
                List<Ayudante> ayudantes = controlador.consultarAyudantesDeProyecto();
                actualizarTablaAyudantes(ayudantes);
    ...
    public Map<String, Object> mostrarDialogoDarDeBaja() {
        ...
        if (resultado == JOptionPane.OK_OPTION) {
            ...
            ToastMessage.mostrar(this, "Ayudante dado de baja correctamente", ToastMessage.TipoToast.EXITO);
